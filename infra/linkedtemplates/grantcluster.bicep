...
var ModulesURL = uri(_artifactsLocation, '/DSC/GRANTCLUSTER.zip${_artifactsLocationSasToken}')
var ConfigurationFunction = 'GRANTCLUSTER.ps1\\GRANTCLUSTER'
...
resource computerName_Microsoft_Powershell_DSC 'Microsoft.Compute/virtualMachines/extensions@2019-03-01' = {
  ...
  properties: {
    ...
    settings: {
      ModulesUrl: '${_artifactsLocation}/DSC/GRANTCLUSTERN.zip?raw=true'
